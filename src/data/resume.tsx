...
export const DATA = {
  ...
  contact: {
    ...
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/subratadasGit",
        icon: Icons.github,
  ...
  education: [
    {
      ...
      logoUrl: "/Heritage_Institute_of_Kolkata_Logo.png",
      start: "2023",
      end: "2025",
    },
    {
      school: "Bangabasi College , Sealdah",
      href: "https://www.bangabasi.ac.in/",
      degree: "Bachelor's Degree of Computer Science ( BCS )",
      logoUrl: "/bangabasi.jpeg",
      start: "2020",
      end: "2023",
    },
    // {
  ...
  projects: [
    {
      title: "One and Only Cafe",
      href: "https://chatcollect.com",
      dates: "Jan 2024 - Feb 2024",
      active: true,
      description:
        "The One & Only Cafe website is built using a combination of PHP and MySql, ensuring a smooth, scalable, and secure experience for users.",
      technologies: [
        "html",
        "TailwindCss",
        "MySQl",
